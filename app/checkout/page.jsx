...
const paymentMethods = [
  ...
  },
  {
    ...
    name: "JazzCash",
    context:
      "Send your payment to Jazz Cash on this number: <a class='text-light-blue-800' href='https://wa.me/923047210222?text=Hi, please guide me i want to pay using jazzcash for a order on your website' target='_blank'>0333 7210227</a>, and <a class='text-light-blue-800' target='_blank' href='https://wa.me/923047210222=Hi, please guide me i share my screenshot with you of my payment'> send us a screenshot </a>",
    identifier: "JZC",
  },
  {
    icon: "/easypaisa.webp",
    name: "EasyPaisa",
    context:
      "Send your payment to easypaisa on this number: <a class='text-light-blue-800' href='https://wa.me/923047210222?text=Hi, please guide me i want to pay using easypasia for a order on your website' target='_blank'>0333 7210227</a>, and <a class='text-light-blue-800' target='_blank' href='https://wa.me/923047210222=Hi, please guide me i share my screenshot with you of my payment'> send us a screenshot </a>",
    identifier: "EZP",
  },
  {
    icon: "/bank.webp",
    name: "Bank Transfer",
    context:
      "UBL Bank IBAN  <br/> Account Number: <b> PK04 UNIL 0109 0003 1207 0863 </b> <br/>  <a class='text-light-blue-800' target='_blank' href='https://wa.me/923047210222?text=Hi, please guide me i share my screenshot with you of my payment'> send us a screenshot </a>",
    identifier: "BT",
  },
];
  ...
  return (
    <>
      <header className=" py-8 text-center bg-white border-b-4">
        <h1 className="text-4xl">Sindh Achar House</h1>
      </header>
